...
<template>
  ...
  <fieldset>
    ...
    <input id="filter_all" v-model="all" type="checkbox" />
  ...
  <table>
    ...
    <tbody>
      <tr v-for="device of devices" :key="device.uuid">
        ...
        <td>
          <input v-model="device.enabled" type="checkbox" @change="deviceStore.save(device)" />
        </td>
        <td>
          <input type="submit" value="Save" @click="deviceStore.save(device)" />
          <input type="submit" value="Remove" @click="deviceStore.remove(device.uuid)" />
        </td>
      </tr>
    </tbody>
  </table>
