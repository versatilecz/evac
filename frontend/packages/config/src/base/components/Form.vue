...
<template>
  <form v-if="formData" class="grid grid-cols-3 gap-4" @submit.prevent>
    <label class="label col-start-1 row-start-1" for="config-configPath">
    ...
    <label class="label col-start-1 row-start-2" for="config-dataPath">
    ...
    <label class="label col-start-1 row-start-3" for="config-frontendPath">
    ...
    <label class="label col-start-2 row-start-1" for="config-portBroadcast">
    ...
    <label class="label col-start-2 row-start-2" for="config-portScanner">
    ...
    <label class="label col-start-2 row-start-3" for="config-portWeb">
    ...
    <label class="label col-start-3 row-start-1" for="config-querySize">
    ...
    <label class="label col-start-3 row-start-2" for="config-routine">
    ...
    <label class="label col-start-3 row-start-3" for="config-salt">
